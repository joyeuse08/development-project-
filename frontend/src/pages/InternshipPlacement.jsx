...
export default function InternshipPlacement() {
  ...
  useEffect(() => {
    ...
    fetch("/api/Internship_placements/", {
      headers: {
          ...
          <div style={styles.card}>
            ...
            <div style={styles.grid}>
              <div style={styles.infoBox}>
                ...
                <span style={styles.value}>
                  {placement.start_date
                    ? new Date(placement.start_date).toLocaleDateString("en-GB", { day: "2-digit", month: "long", year: "numeric" })
                    : "—"}
                </span>
              </div>
              ...
              <div style={styles.infoBox}>
                ...
                <span style={styles.value}>
                  {placement.end_date
                    ? new Date(placement.end_date).toLocaleDateString("en-GB", { day: "2-digit", month: "long", year: "numeric" })
                    : "—"}
                </span>
              </div>
              ...
              <div style={styles.infoBox}>
                ...
                <span style={{ ...styles.value, color: status.color, fontWeight: 700 }}>
                  {status.label}
                </span>
              </div>
            </div>
